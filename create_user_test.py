...
#тест создания пользователя 2 буквы в имени получить успешный ответ
...
#тест создания пользователя 15 букв в имени получить успешный ответ
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Aaааааааааааааа")

# Подготовка к 3му тесту
